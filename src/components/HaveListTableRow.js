...
class HaveListTableRow extends React.Component {
  ...
  render() {
    return (
      <Table.Row>
          ...
          <Table.Cell>${this.props.item.listingPrice}</Table.Cell>
          <Table.Cell>
...
const connectedHaveListTableRow = connector(HaveListTableRow)

export default connectedHaveListTableRow